...
namespace Selling_Vegetable_26102023
{
	public class Startup
	{
		...
		{
			var stringContextDb = Configuration.GetConnectionString("dbSellingVegetable");
			services.AddDbContext<SellingVegetableContext>(options => options.UseSqlServer(stringContextDb));
