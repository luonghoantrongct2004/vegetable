...
namespace Selling_Vegetable_26102023.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(SellingVegetableContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,Username,Password,Avatar,Address,FullName,Email,Phone,Birthday,LastLogin,CreatedAt,Active")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,Username,Password,Avatar,Address,FullName,Email,Phone,Birthday,LastLogin,CreatedAt,Active")] Customer customer)
        {
